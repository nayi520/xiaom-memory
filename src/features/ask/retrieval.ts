...
/** 问答召回 top-K（最终拼进上下文/来源的概念数；任务要求 6~8） */
export const ASK_TOP_K = 8;
/**
 * 重排序候选池大小（V16）：先按余弦多召回这么多条候选，再交给重排序挑出最相关的 ASK_TOP_K 个。
 * 比 ASK_TOP_K 大，给重排序留出「捞回排名略低但更相关」的空间；不改对外契约，仅提升答案质量。
 */
export const ASK_RERANK_CANDIDATES = 16;
/**
